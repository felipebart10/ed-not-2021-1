...
*/
const densidadeDemografica = (area, pop) => pop / area
...
for (let i = 0; i < estadosNe.length; i++) {
    estadosNe[i].densidade = densidadeDemografica(estadosNe[i].area, estadosNe[i].populacao)
    console.table(estadosNe[i])
}
